    ...
    openReviewLink() {
        if (chrome.extension) {
            if (navigator.userAgent.indexOf("Edg") != -1) {
                ...
                chrome.tabs.create({ url: 'https://chromewebstore.google.com/detail/boxel-golf/mmgjkfjlmdkmoipndaeombfnomjfgeff/reviews' });
            }
            else if (navigator.userAgent.indexOf("Firefox") != -1) {
                chrome.tabs.create({ url: 'https://addons.mozilla.org/en-US/firefox/addon/boxel-golf-game/' });
            }
        }
        else {
